...
if($id == '')
	...
	if(count($detailArr)>0)
	{
		...
		<table width="100%" border="0" cellspacing="10" cellpadding="1" class="payout-summary">
            ...
            <?php if($detailArr['total_amt']<=$detailArr['cap_limit'] || $detailArr['cap_limit'] !=0.00){ ?>
            <tr>
			...
			<tr>
				<td width="50%"><strong><?php _e('Net Amount','binary-mlm-pro');?><?= ($detailArr['total_amt']<=$detailArr['cap_limit'] || $detailArr['cap_limit']==0.00)?'':'(capped)'; ?></strong>	</td>
...
('Your Withdrawal Request Initiated','binary-mlm-pro');?></div>
				...
				<?php } else if($statusArray[0]['payment_processed']=='1' && $statusArray[0]['withdrawal_initiated']=='1'){?>
				...
				<?php } else if($statusArray[0]['payment_processed']=='0' && $statusArray[0]['withdrawal_initiated']=='0'){?>
				
				<div id="comment_form">
					<form name="contact" method="post" action="">
						<fieldset>
								<label for="name" id="name_label"><b><?php _e('Comment, if any','binary-mlm-pro');?>:</b>&nbsp;&nbsp;</label>
...
function paymentDeatil($memberId,$payoutId){
	...
	if(isset($memberId) && isset($payoutId))
	{
		...
		if($detail['payment_mode']=='cheque'){ ?>
			...
			<table><tr>
            <th><?= __('Withdrawal Date','nibary-mlm-pro'); ?></th>
           <th><?= __('Payment Date','nibary-mlm-pro'); ?> </th>
            <th><?= __('Payment Mode','nibary-mlm-pro'); ?> </th>
            <th><?= __('Payment Detail','nibary-mlm-pro'); ?></th></tr>
            <tr><td><?= $detail['withdrawal_initiated_date'] ?></td>
            <td><?= $detail['payment_processed_date']; ?></td>
            <td><?= $detail['payment_mode'] ?></td>
            <td><?= __('Cheque No','nibary-mlm-pro'); ?>:&nbsp;<?=$detail['cheque_no']?><br/>
            <?= __('Cheque Date','nibary-mlm-pro'); ?>: &nbsp;<?=$detail['cheque_date']?><br/>
            <?= __('Bank Name','nibary-mlm-pro'); ?>:&nbsp;<?=$detail['bank_name']?><br/></td></tr></table>
		<?php }
		else
		...
		{ ?>
            ...
            <td><?= $detail['payment_processed_date']; ?></td>
            <td><?= $detail['payment_mode']; ?></td>
            <td><?= __('Benificiary','nibary-mlm-pro'); ?>:&nbsp;<?= $detail['beneficiary']; ?><br/>
            <?= __('Account No','nibary-mlm-pro'); ?>: &nbsp;<?= $detail['user_bank_account_no']; ?><br/>
            <?= __('Banktransfer Code','nibary-mlm-pro'); ?>: &nbsp;<?= $detail['banktransfer_code']; ?><br/>
            <?= __('Bank Name','nibary-mlm-pro'); ?>:&nbsp;<?= $detail['user_bank_name']; ?> <br/></td></tr></table>
		<?php }
		...
		{ ?>
            ...
            <th><?= __('Withdrawal Date','nibary-mlm-pro'); ?></th>
            <th><?= __('Payment Date','nibary-mlm-pro'); ?> </th>
            <th><?= __('Payment Mode','nibary-mlm-pro'); ?> </th></tr>
            <tr><td><?= $detail['withdrawal_initiated_date']; ?></td>
            <td><?= $detail['payment_processed_date']; ?></td>
