...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
		<tr>
			...
			<td>
		<input type="text" name="direct_referral" id="direct_referral" size="10" value="<?php if(!empty($_POST['direct_referral'])) _e(htmlentities($_POST['direct_referral']));?>">
		...
		<tr>
			...
			<td>
		<input type="text" name="right_referral" id="right_referral" size="10" value="<?php if(!empty($_POST['right_referral'])) _e(htmlentities($_POST['right_referral']));?>">
		...
		<tr>
			...
			<td>
		<input type="text" name="left_referral" id="left_referral" size="10" value="<?php if(!empty($_POST['left_referral'])) _e(htmlentities($_POST['left_referral']));?>">
...
<?php
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
		<tr>
			...
			<td>
		<input type="text" name="direct_referral" id="direct_referral" size="10" value="<?php if(!empty($mlm_settings['direct_referral'])) _e($mlm_settings['direct_referral']);?>">
				<div class="toggle-visibility" id="mlm_direct_referral"><?php _e('Please specify direct referral by you.','binary-mlm-pro');?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
		<input type="text" name="right_referral" id="right_referral" size="10" value="<?php if(!empty($mlm_settings['right_referral'])) _e($mlm_settings['right_referral']);?>">
				<div class="toggle-visibility" id="mlm_right_referral"><?php _e('Please specify no. of paid referrals on right leg.','binary-mlm-pro');?></div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
		<input type="text" name="left_referral" id="left_referral" size="10" value="<?php if(!empty($mlm_settings['left_referral'])) _e($mlm_settings['left_referral']);?>">
				<div class="toggle-visibility" id="mlm_left_referral"><?php _e('Please specify no. of paid referrals on left leg.','binary-mlm-pro');?></div>
			</td>
		</tr>
		</table>
